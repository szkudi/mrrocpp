...
//
//	virtual boost::shared_ptr <mrrocpp::ecp_mp::sensor::discode::discode_sensor> get_vsp_discode();
//
//private:
////	shared_ptr<generator::bclikeregions_gen> gen;
//	shared_ptr<generator::bclike_gen> bc_smooth;
//	shared_ptr<mrrocpp::ecp_mp::sensor::discode::discode_sensor> vsp_discode;
//
//};
//
//}
